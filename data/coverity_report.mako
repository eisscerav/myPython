...
<body>
    <div class="container_non">
        ...
        <caption class="my_caption-top"><i class="fa fa-info-circle"></i></a></caption>
            <thead class="thead-light">
                <tr>
                    <th data-sortable="true"><b>ID</b></th>
                    <th data-sortable="true"><b>Checker</b></th>
                    <th data-sortable="true"><b>File</b></th>
                    <th data-sortable="true"><b>Line</b></th>
                    <th data-sortable="true"><b>Function</b></th>
                    <th data-sortable="true"><b>Classification</b></th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td>${td_item['ID']}</td>
                    <td>${td_item['Checker']}</td>
                    <td><a target="_blank" href=${td_item['file_href']}>${td_item['File']}</a></td>
                    <td>${td_item['Line']}</td>
                    <td>${td_item['Function']}</td>
                    <td>${td_item['Classification']}</td>
                </tr>
                % endfor
            </tbody>
        </table>
